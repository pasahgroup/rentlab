  ...
  <link href="../../../frontendp/lib/animate/animate.min.css" rel="stylesheet" type="text/css" />
    ...
    <body>
            ...
            <div class="container">
                ...
                @forelse($social_icons as $item)
                            <li class="float-right">
                                <a href="{{ $item->data_values->url }}" class="btn btn-light btn-sm-square rounded-circle me-0">
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item">
                        <img src="frontendp/img/carousel-1.jpg" class="img-fluid w-100" alt="First slide"/>
                        <div class="carousel-caption">
                            <div class="container py-4">
                                <div class="row g-5">
                                    <div class="col-lg-6 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
        ...
        <a href="#" class="btn btn-secondary btn-lg-square rounded-circle back-to-top"><i class="fa fa-arrow-up"></i></a>   
          ...
          <script src="../../frontendp/js/jquery364.min.js" type="text/javascript"></script>
           <script src="../../frontendp/js/bundle.min.js" type="text/javascript"></script>
