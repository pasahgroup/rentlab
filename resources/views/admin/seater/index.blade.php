                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two">
                            <thead>
                            <tr>
                                <th scope="col">@lang('Number of seat')</th>
                            ...
                            @forelse ($seaters as $item)
                                <tr>
                                    <td data-label="@lang('Number of seat')"><strong>{{ __($item->number) }} @lang('Seater')</strong></td>
                                    ...
                                    <td data-label="@lang('Action')">
                                        <a href="javascript:void(0)" class="icon-btn ml-1 editBtn" data-original-title="@lang('Edit')" data-toggle="tooltip" data-url="{{ route('admin.seater.update', $item->id)}}" data-number="{{ $item->number }}">
                                            <i class="la la-edit"></i>
                                        </a>

                                        <a href="javascript:void(0)" class="icon-btn {{ $item->status ? 'btn--danger' : 'btn--success' }} ml-1 statusBtn" data-original-title="@lang('Status')" data-toggle="tooltip" data-url="{{ route('admin.seater.status', $item->id) }}">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="{{ route('admin.seater.store')}}">
                    @csrf

                    <div class="modal-body">
                        <div class="form-row form-group">
                            <label for="name" class="font-weight-bold">@lang('Number of seat') <span class="text-danger">*</span></label>
                            <div class="col-sm-12">
