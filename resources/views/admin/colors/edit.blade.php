...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.color.update', $vehicle->id) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                      <label for="name">@lang('Car Color')</label>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.color.index') }}" class="btn btn-sm btn--primary box--shadow1 text-white text--small"><i
