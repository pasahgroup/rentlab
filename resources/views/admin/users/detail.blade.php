            ...
            <div class="card b-radius--10 overflow-hidden mt-30 box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Total Payments')
                            <span class="font-weight-bold"><a href="{{route('admin.users.deposits',$user->id)}}">{{__($general->cur_sym)}}{{showAmount($totalDeposit)}}</a></span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row mb-none-30">
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--indigo b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.vehicles.booking.log', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--13 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.vehicles.booking.log.upcoming', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--14 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.vehicles.booking.log.running', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--success b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.vehicles.booking.log.completed', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--16 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.plans.booking.log', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--17 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.plans.booking.log.upcoming', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-hourglass-half"></i>
                        </div>
                        <div class="details">
                            ...
                            <div class="desciption">
                                <span>@lang('Upcoming Plan Booking')</span>
                            </div>
                        </div>
                    </div>
                </div><!-- dashboard-w1 end -->
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--18 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.plans.booking.log.running', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-spinner"></i>
                        </div>
                        <div class="details">
                ...
                <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--19 b-radius--10 box-shadow has--link">
                        <a href="{{ route('admin.user.plans.booking.log.completed', $user->id) }}" class="item--link"></a>
                        <div class="icon">
                            <i class="las la-check-circle"></i>
                        </div>
                        <div class="details">
