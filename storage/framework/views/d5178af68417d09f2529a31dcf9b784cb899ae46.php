        ...
        <div class="col-lg-12">
            <div class="card b-radius--10 ">
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light tabstyle--two">
                            ...
                            <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $booking_logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Vehicle'); ?>"><?php echo e(__($log->vehicle->name)); ?></td>
                                    <td data-label="<?php echo app('translator')->get('Pick - Drop Location'); ?>"><?php echo e(__(@$log->pick_up_location->name)); ?> <br>
                ...
                <div class="card-footer">
                    <?php echo e($booking_logs->links('admin.partials.paginate')); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentlab\resources\views/admin/vehicle/bookinglog.blade.php ENDPATH**/ ?>