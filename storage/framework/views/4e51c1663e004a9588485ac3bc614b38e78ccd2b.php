                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="price" name="price"
                                               value="<?php echo e(getAmount($plan->price)); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="days" name="days"
                                               value="<?php echo e(getAmount($plan->days)); ?>" required>
                                        <div class="input-group-append">
                                ...
                                <div class="card border--dark">
                                    ...
                                    <div class="card-body">
                                        <div class="row addedField">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $plan->included; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="col-md-12 other-info-data">
                                                    <div class="form-group">
                                                        <div class="input-group mb-md-0 mb-4">
                                                            <div class="col-md-11">
                                                                <input name="included[]" class="form-control"
                                                                       type="text" value="<?php echo e($inc); ?>" required
                                                                       placeholder="<?php echo app('translator')->get('Included'); ?>">
                                                            </div>
                                ...
                                <div class="card border--dark">
                                    ...
                                    <div class="card-body">
                                        <div class="row addedFieldExcluded">
                                            ...
                                            <?php if($plan->excluded): ?>
                                                <?php $__currentLoopData = $plan->excluded; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-12 other-info-data">
                                                        <div class="form-group">
                                                            <div class="input-group mb-md-0 mb-4">
                                                                <div class="col-md-11">
                                                                    <input name="excluded[]" class="form-control"
                                                                           type="text" value="<?php echo e($exc); ?>" required
                                                                           placeholder="<?php echo app('translator')->get('Excluded'); ?>">
                                                                </div>
                                                                <div class="col-md-1 mt-md-0 mt-2 text-right">
                                                                <span class="input-group-btn">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentlab\resources\views/admin/plan/edit.blade.php ENDPATH**/ ?>