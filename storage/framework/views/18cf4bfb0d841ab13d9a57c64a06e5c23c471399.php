    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7 text-center">
          ...
          <h2 class="title"><b><?php echo app('translator')->get('404'); ?></b> <?php echo app('translator')->get('Page not found'); ?></h2>
          <p><?php echo app('translator')->get('page you are looking for doesn\'t exit or an other error occured'); ?> <br> <?php echo app('translator')->get('or temporarily unavailable.'); ?></p>
...
</html><?php /**PATH C:\xampp\htdocs\rentlab\resources\views/errors/404.blade.php ENDPATH**/ ?>