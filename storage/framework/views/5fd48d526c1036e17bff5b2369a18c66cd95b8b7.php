                        ...
                        <table class="table table--light tabstyle--two">
                            ...
                            <tr>
                                <th scope="col"><?php echo app('translator')->get('ID'); ?></th>
                                   <th scope="col"><?php echo app('translator')->get('Car Model'); ?></th>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('admin.offer.add')); ?>" class="btn btn-sm btn--primary box--shadow1 text-white text--small"><i class="fa fa-fw fa-plus"></i><?php echo app('translator')->get('Add Offer'); ?></a>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentlab\resources\views/admin/offer/index.blade.php ENDPATH**/ ?>