        ...
        <div class="header-carousel">
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
                <ol class="carousel-indicators">
                    ...
                    <li data-bs-target="#carouselId" data-bs-slide-to="<?php echo e($indexKey); ?>" aria-label="Second slide"></li> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                   
                </ol>
...
<a href="#" class="text-start text-white d-block mb-2">Need a different drop-off location?</a>
  ...
  <div class="d-flex align-items-center bg-light text-body rounded-start p-2">
    ...
    <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $indexKey => $DailyReader): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  
