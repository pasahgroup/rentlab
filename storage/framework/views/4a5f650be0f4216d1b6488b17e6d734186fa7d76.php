...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="container steps py-1" id="section7">
      <div class="container py-4">
          <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
              ...
              <p class="mb-0 text-white demo-1"><?php echo e($main_service->content?? 'No Content'); ?>
          ...
          <div class="row g-4">
              <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                  <div class="steps-item p-4 mb-4">
                      <h4 class="mb-3"><?php echo e($wedding->title?? 'No Title'); ?></h4>
 ...
 <!-- <a href="<?php echo e(route('vehicle.details', [$metaFirstVehicle->id, slug($metaFirstVehicle->name)])); ?>" class="btn btn-primary rounded-pill d-flex justify-content-center py-1 px-4" style="margin-bottom:0px;">Book</a> -->
              ...
              <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                  <div class="steps-item p-4 mb-4">
                      <h4 class="mb-3"><?php echo e($escort->title?? 'No Title'); ?></h4>
                      <p class="mb-0 demo-1"><?php echo e($escort->content?? 'No Content'); ?></p>
                      <div class="setps-number text-primary">Explore More
              ...
              <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="steps-item p-4 mb-4">
                      <h4 class="mb-3"><?php echo e($car_hiring->title?? 'No Title'); ?></h4>
