                           ...
                           <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="price" name="price"
                                               value="<?php echo e($multibooking->price); ?>" min="10000" required>
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="no_car" class="form-control" value="<?php echo e($multibooking->no_car); ?>"
                             ...
                             <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="no_days" class="form-control" value="<?php echo e($multibooking->no_days); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="total_costs" name="total_costs"
                                               value="<?php echo e($multibooking->total_costs); ?>" readonly>
                                        <div class="input-group-append">
                                            <div class="input-group-text"><?php echo e($general->cur_text); ?></div>
                                        </div>
                                    </div>
...
<?php echo $__env->make($activeTemplate.'layouts.frontendm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentlab\resources\views/admin/multibookings/edit.blade.php ENDPATH**/ ?>