...
<?php $__env->startSection('panel'); ?>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('admin.color.update', $vehicle->id)); ?>" method="post"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                      <label for="name"><?php echo app('translator')->get('Car Color'); ?></label>
                                    <input type="text" id="color" name="color" class="form-control"
                                           value="<?php echo e($vehicle->color); ?>">
                                </div>
                            </div>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="<?php echo e(route('admin.color.index')); ?>" class="btn btn-sm btn--primary box--shadow1 text-white text--small"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentlab\resources\views/admin/colors/edit.blade.php ENDPATH**/ ?>